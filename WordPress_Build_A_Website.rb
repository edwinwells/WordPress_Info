#WordPress (WP), a web-cased toolnthat can be used to build websites of all types.
...
#The theme will determine the entire presentation's morphsing... scroll text/change photo, etc.
